...
import com.example.content_generator.dataservice.model.BrochureUploadRequest;
...
public class BrochureController {
    ...
    /**
     * Uploads a file and associates it with a product.
     *
     * <p>Processes the uploaded file and associates it with the specified product ID. The file URL is generated and saved in the database.</p>
     *
     * <ul>
     *     <li>The file is uploaded and its URL is generated by {@link BrochureService#uploadFileUsingProductId(String, MultipartFile)}.</li>
     *     <li>A {@link BrochureDTO} is created with the provided product ID and the generated file URL.</li>
     *     <li>The created brochure is saved to the database and returned in the response.</li>
     * </ul>
     *
     * @param request The request containing the product ID and the file to upload.
     ...
     */
    @PostMapping("/upload")
    public ResponseEntity<BrochureDTO> uploadFile(@ModelAttribute BrochureUploadRequest request) {
